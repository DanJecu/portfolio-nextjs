    ...
    >
      ...
      <div className="my-auto w-[85%] pb-7  md:pt-16 lg:flex lg:flex-col lg:items-stretch lg:justify-center lg:pt-0">
        <p
          ...
          ref={ref}
        >
          I am a passionate self-taught full stack developer with a life-long
          learning mentality, dedicated to optimizing business operations
          through user-first design and custom software solutions. <br /> With a
          strong background in data analysis, I specialize in creating
          responsive layouts using the JavaScript stack of React and NodeJS, as
          well as Typescript, Python and SQL.
        </p>
        <div className="my-[30px] hidden  lg:m-auto lg:inline lg:pt-24 xl:pt-48 xl:text-2xl">
          ...
          <TextScroll text="Data Analyst &middot; " direction="right" />
          <TextScroll text="Stoic Millenial &middot; " direction="left" />
        </div>
      </div>
    </section>
  );
