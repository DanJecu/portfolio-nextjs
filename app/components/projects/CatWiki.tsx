      ...
      <div className="lg:w-[50%] lg:place-self-center">
        ...
        <div className="flex flex-wrap justify-center gap-3 lg:mx-auto lg:w-9/12">
          ...
          <span className="flex items-center gap-1 rounded-xl bg-card p-[.30rem] text-black">
            ...
            />
            <h5 className="text-xs text-secondary">Styled Components</h5>
          </span>
          <span className="flex items-center gap-1 rounded-xl bg-card p-[.35rem] text-black">
            <Image
              ...
              alt="framer motion"
            />
            <h5 className="text-xs text-secondary">Framer Motion</h5>
          </span>
        </div>
        ...
        <p className="m-auto w-11/12 pt-6 text-center text-sm font-light leading-5 tracking-wide text-secondary lg:text-[1.08rem] lg:leading-7">
          Web application showcasing the diverse range of cat breeds worldwide.
          Lightning-fast and efficiently designed, this app utilizes statically
          generated pages derived from pre-fetched and optimized API data, all
          powered by the cutting-edge NextJS framework.
        </p>
        <div className="[&>*:font-bold] flex justify-evenly py-6 text-[1rem] text-white">
          <button className="button">
            <a target="_blank" href="https://github.com/danJecu/cats-wiki">
              SOURCE
            </a>
          </button>
          <button className="button">
            <a target="_blank" href="https://cats-wiki-orpin.vercel.app/">
              LIVE
            </a>
          </button>
        </div>
