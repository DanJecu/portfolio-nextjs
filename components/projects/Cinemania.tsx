        ...
        <>
            <div className='lg:place-self-center'>
                ...
                <p className='m-auto w-11/12 pt-6 text-center text-sm font-light leading-5 tracking-wide text-secondary lg:text-[1.08rem] lg:leading-7'>
                     Cinemania is a dynamic movie app developed using React, Material-UI (MUI), Emotion, and Express.js. This app is designed to be your go-to companion for all things movies, providing a seamless and immersive experience for movie enthusiasts.
                </p>
