    ...
    return (
        <div className="flex flex-col-reverse pt-20 lg:m-auto lg:h-screen lg:w-[95vw] lg:flex-row lg:justify-evenly">
            ...
            <div className="flex gap-16" style={style}>
                <div className="relative m-auto hidden h-[80vh] w-[80%] rounded-lg md:w-[38%] lg:h-[80%] xl:block xl:w-[75%]">
                    <img
                        key="1"
                ...
                <div
                    ref={ref}
                    className="relative m-auto h-[80vh] w-[80%] rounded-lg md:w-[38%] lg:h-[80%] lg:w-[100%] xl:w-[75%]"
                >
                    <img
                        key="1"
                        className="h-full w-full rounded-lg object-fill lg:h-[100%]"
